            ...
            <tr>
              <td align="center" valign="top">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_header"
                  style='background-color: #545454; color: #ffffff; border-bottom: 0; font-weight: bold; line-height: 100%; vertical-align: middle; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; border-radius: 3px 3px 0 0;'>
                  <tr>
                    <td id="header_wrapper" style="padding: 36px 48px; display: block;">
                      <h1
                        style='font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #767676; color: #ffffff;'>
                        New Order: #86/ZS/2020-07-09</h1>
                    </td>
                  </tr>
                </table>
                <!-- End Header -->
                        ...
                        <tr>
                          <td valign="top" style="padding: 48px 48px 32px;">
                            <div id="body_content_inner"
                              ...
                              <p style="margin: 0 0 16px;">You’ve received the following order from Xuan Duy Nguyen:</p>

                              <h2
                                style='color: #545454; display: block; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 18px; font-weight: bold; line-height: 130%; margin: 0 0 18px; text-align: left;'>
                                <a class="link" href="https://store.zim.vn/wp-admin/post.php?post=1964&amp;action=edit"
                                  style="font-weight: normal; text-decoration: underline; color: #545454;">[Order
                                  #86/ZS/2020-07-09]</a> (July 9, 2020)</h2>
                                  ...
                                  <tbody>
                                    <tr class="order_item">
                                      <td class="td"
                                        ...
                                        Understanding Vocab for IELTS Speaking - Ebook (#UVSE) </td>
                                      <td class="td"
                                      ...
                                      <td class="td"
                                        style="color: #636363; border: 1px solid #e5e5e5; padding: 12px; text-align: left; vertical-align: middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
                                        <span class="woocommerce-Price-amount amount">100,000<span
                                ...
                                <tr>
                                  <td valign="top" width="50%"
                                    ...
                                    <address class="address"
                                      ...
                                      Xuan Duy Nguyen<br>189 Hồ Sen<br>Hải Phòng <br><a href="tel:0936479688"
                                        style="color: #545454; font-weight: normal; text-decoration: underline;">0936479688</a>
                                      <br>doanthutrangvakt3@gmail.com </address>
                                  </td>
                                </tr>
                              </table>
                ...
                <table border="0" cellpadding="10" cellspacing="0" width="100%">
                  <tr>
                    <td colspan="2" valign="middle" id="credit"
                      ...
                      <p style="margin: 0 0 16px;">ZIM Store —</p>
                    </td>
                  </tr>
                </table>
              </td>
